...
# Path file log
log_file_path = r'C:\Users\HP\Downloads\GPON02-KEP LOGX.log'
with open(log_file_path, 'r', encoding='utf-8') as file:
    log_data = file.read()

# Pisahkan data berdasarkan port menggunakan pemisah yang konsisten
port_sections = log_data.split('GPON02-D5-KEP-3#sho pon onu information')
...
output_file_path = r'C:\Users\HP\Downloads\GPON02-KEP-Analysis.xlsx'
