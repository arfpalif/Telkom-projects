...
# Path file log
log_file_path = r'C:\Users\HP\Downloads\GPON01-KEP LOGX.log'
with open(log_file_path, 'r', encoding='utf-8') as file:
    log_data = file.read()

# Pisahkan data berdasarkan port menggunakan pemisah yang konsisten
port_sections = log_data.split('GPON01-D5-KEP-3#sho pon onu information')
...
# Ganti dengan path file output Anda
output_file_path = r'C:\Users\HP\Downloads\GPON01-KEP-Analysis.xlsx'
